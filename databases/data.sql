...
INSERT INTO `branches` VALUES (1,'Minor','Minorda joylashgan',1),(2,'Chorsu','Bu Toshkent shahridagi Chorsu filyali',1),(3,'Payariq','Bu Samarqand Payariq filyali.',2),(4,'G\'allarol','Bu Samarqand shahridagi G\'allarol filyali.',2),(5,'Xovos','Bu Sirdaryo viloyatidagi Xovos filyali.',3),(6,'Sirdaryo','Bu Sirdaryo shahridagi Sirdaryo filyali.',3);
/*!40000 ALTER TABLE `branches` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Temporary view structure for view `course_branch_region`
--

DROP TABLE IF EXISTS `course_branch_region`;
/*!50001 DROP VIEW IF EXISTS `course_branch_region`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `course_branch_region` AS SELECT 
 1 AS `id`,
 1 AS `course_name`,
 1 AS `course_info`,
 1 AS `branch_name`,
...
CREATE TABLE `courses` (
  ...
  CONSTRAINT `fk_course_info` FOREIGN KEY (`branch_id`) REFERENCES `branches` (`id`) ON DELETE CASCADE
...
INSERT INTO `regions` VALUES (1,'Toshkent'),(2,'Samarqand'),(3,'Sirdaryo');
...
CREATE TABLE `users` (
  ...
  CONSTRAINT `users_ibfk_1` FOREIGN KEY (`course_id`) REFERENCES `courses` (`id`) ON DELETE CASCADE
...
--
-- Final view structure for view `course_branch_region`
--
...
-- Dump completed on 2025-02-03  1:32:44
